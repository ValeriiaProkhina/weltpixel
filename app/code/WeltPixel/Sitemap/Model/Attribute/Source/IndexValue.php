 ...
 */
class IndexValue extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource implements SourceInterface, OptionSourceInterface
{

    const INDEX_INDEX = 1;
    const INDEX_NOINDEX = 0;

    public function getAvailableOptions() {
        return [
            self::INDEX_INDEX => __('INDEX'),
            self::INDEX_NOINDEX  => __('NOINDEX')
        ];
    }
